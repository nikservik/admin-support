    ...
    <div class="sm:ml-2">
        <form action="/{{ config('admin-support.route') }}/search" role="search" style="white-space: nowrap;">
            <input class="py-1 px-3 w-auto border border-r-0 rounded-l-lg border-gray-400 focus:outline-none"
                type="text" name="q" value="{{ $query ?? '' }}" placeholder="@lang('admin-support::admin.placeholder')" required><button type="submit" class="py-1 px-3 border rounded-r-lg border-indigo-500 bg-indigo-500 text-white">
