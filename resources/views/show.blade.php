...
<h1 class="page-header">
    <a href="/{{ config('admin-support.route') }}" class="text-white">@lang('admin-support::admin.list-title')</a>
</h1>
<h2 class="sub-header">
...
<div class="my-4 mx-2 md:mx-10 pl-10">
	<form action="/{{ config('admin-support.route') }}/dialog/{{ $user->id }}#read" method="POST">
		@csrf
		<div class="flex">
			<div class="w-full">
